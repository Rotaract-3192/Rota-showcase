                ...
                <div className="flex flex-col gap-4">
                  ...
                  {selectedItem.data.transcript_text && (
                    <div>
                      ...
                      <div className="p-3 bg-navy-deep rounded border border-slate-800/80 text-xs leading-relaxed max-h-40 overflow-y-auto whitespace-pre-wrap break-words font-mono">
                        {selectedItem.data.transcript_text}
                      </div>
                    </div>
                  )}
